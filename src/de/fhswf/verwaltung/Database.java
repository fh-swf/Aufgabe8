	...
	private void initDataBase() {
		...
		try {
			...
			// Füllen der Tabelle mit Einträgen
				...
				update("INSERT INTO fahrer(name, fklasse, fseit) VALUES('Schmidt', 2, '" + date1 + "')");
				update("INSERT INTO fahrer(name, fklasse, fseit) VALUES('Heinzen', 5, '" + date2 + "')");
	...
	private void runTestSzenario(){
		try {
			...
			while (rs1.next()) {
		        ...
		        Integer fKlasse = rs1.getInt("fklasse");
